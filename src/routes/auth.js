...
const { register, login, verifyOtp, socialUrl, getSettings, sendCall, test, googleLogin, appleLogin, getCountryByIp, checkReferralCode } = require('../controllers/authController');
